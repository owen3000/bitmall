...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/assets/js/product/product_detail.js">
</script>

<style type="text/css">
#b-order:hover{ cursor: pointer;}
#b-cart:hover{ cursor: pointer;}
</style>
</head>
<body style="margin:0">
...
<!-------------------------------------------------------------------------------------------->	
			...
			<!-- form2 시작  -->
			<form id="form-product-detail" name="form2" method="post" action="${pageContext.servletContext.contextPath }/cart/insert">
			<input type="hidden" name="product-no" value="${map.productVO.no }">
			<input type="hidden" name="kind" value="insert"> 
			<input type="hidden" name="discount-price" value="<fmt:parseNumber value="${map.productVO.price-map.productVO.price/100*(map.discount) }" integerOnly="true"/>">
						...
						<table border="0" cellpadding="0" cellspacing="1" width="315" height="315" bgcolor="D4D0C8">
							<tr>
								<td bgcolor="white" align="center">
									<img src="${pageContext.servletContext.contextPath }/uploads/images/${map.imageList[0].saveName}" height="315" border="0" align="absmiddle" ONCLICK="Zoomimage('0000')" STYLE="cursor:hand">
								</td>
							</tr>
						</table>
					</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							...
							<tr>
								...
								<td style="padding-left:10px">
									<font color="282828">${map.productVO.name }</font><br>
							...
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td style="padding-left:10px"><font color="0288DD"><b><fmt:formatNumber value="${map.productVO.price-map.productVO.price/100*(map.discount) }" type="number"/>원</b></font></td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 옵션 -->
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td style="padding-left:10px">
									<select id="opt-color" name="color" class="cmfont1">
										<option value="">선택하세요</option>
										<c:forEach items="${map.color }" var="l">
											<option value="${l.no }">${l.value }</option>
										</c:forEach>
									</select> &nbsp;
									<select id="opt-size" name="size" class="cmfont1">
										<option value="">선택하세요</option>
										<c:forEach items="${map.size }" var="l">
											<option value="${l.no }">${l.value }</option>
										</c:forEach>
									</select>
								</td>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="746">
				<tr>
					<td align="center" class="cmfont">궁금하신 사항은 언제든지 연락주세요.(카톡가능)</td>
				</tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" width="746" class="cmfont">
				<tr><td height="10"></td></tr>
