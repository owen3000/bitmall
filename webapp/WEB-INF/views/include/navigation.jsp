...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td valign="top"> 
						<!--  Category 메뉴 : 세로인 경우 -------------------------------->
						<table width="100%"  border="1" cellpadding="2" cellspacing="1" bgcolor="#262626">
							<tr><td height="3"  bgcolor="#bfbfbf"></td></tr>
							<tr><td bgcolor="#E3E3E3" align="center" style="font-size:10pt;color:#333333; padding: 10px;"><b>Category</b></td>
							
							<c:forEach items="${categoryList }" var="l" varStatus="status">
								<tr>
									<td bgcolor="#FFFFFF">
										<table width="100%"  border="0" cellspacing="0" cellpadding="0">
											<tr id="category-tr"><td ><a href="${pageContext.servletContext.contextPath }/?category-no=${l.no }"><font style="color: #292929">${l.name }</font></a></td></tr>
										</table>
									</td>
								</tr>	
							</c:forEach>
