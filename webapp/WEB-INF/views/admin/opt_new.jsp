...
<hr width='900' size='3'>
<form id="opt-form" name="form1" method="post" action="${pageContext.servletContext.contextPath}/admin/opt_new">
...
<table width="500" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	<tr> 
		...
		<td width="400" height="20"  bgcolor="#F2F2F2">
			<input id="opt-name" type="text" name="name" value="" size="20" maxlength="20">
		</td>
	</tr>
</table>
<br>
